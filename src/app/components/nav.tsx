        ...
        <div className="relative z-50" role="dialog" aria-modal="true">
            ...
            <div className="relative mr-16 flex w-full max-w-xs flex-1">
                ...
                <nav className="flex flex-1 flex-col">
                    ...
                    <li>
                        <Link href="/" onClick={() => setNavbarOpen(!navbarOpen)} className="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    ...
                    <li>
                        <Link href="/case-study" onClick={() => setNavbarOpen(!navbarOpen)} className="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        <svg className="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    ...
                    <li>
                        <Link href="/documents" onClick={() => setNavbarOpen(!navbarOpen)} className="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                    ...
                    <li>
                        <Link href="/network-map" onClick={() => setNavbarOpen(!navbarOpen)} className="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                        <svg className="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
